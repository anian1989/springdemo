        ...
        if (CollectionUtils.isNotEmpty(lines)) {
            ...
            try {
                for (String line : lines) {
                    ...
                    String url="https://erp.pre.gotozhangsanlisi.com/product/updateStock/"+split[0];
