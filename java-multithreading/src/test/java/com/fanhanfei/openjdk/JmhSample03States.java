...
public class JmhSample03States {
    /*
     * Most of the time, you need to maintain（维护，供养） some state while the benchmark is
...
//        System.out.println("thread name:"+Thread.currentThread().getName());
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(JmhSample03States.class.getSimpleName())
                .threads(10)
                .forks(1)
                .build();
