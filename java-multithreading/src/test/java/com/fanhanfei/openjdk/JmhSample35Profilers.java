 ...
 * @description
 **/
public class JmhSample35Profilers {
    /*
    ...
    public static class Maps {
        ...
        public static void main(String[] args) throws RunnerException {
            Options opt = new OptionsBuilder()
                    .include(JmhSample35Profilers.Maps.class.getSimpleName())
...
//                    .addProfiler(GCProfiler.class)
    ...
    public static class Classy {
        ...
        public static void main(String[] args) throws RunnerException {
            Options opt = new OptionsBuilder()
                    .include(JmhSample35Profilers.Classy.class.getSimpleName())
...
//                    .addProfiler(CompilerProfiler.class)
    ...
    public static class Atomic {
        ...
        public static void main(String[] args) throws RunnerException {
            Options opt = new OptionsBuilder()
                    .include(JmhSample35Profilers.Atomic.class.getSimpleName())
